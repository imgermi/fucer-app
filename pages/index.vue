  ...
  <div class="index">
    ...
    <section class="hero">
      <div class="container">
        ...
        <h2>
          FucerNet es una herramienta digital en la que encontrará, además del
          Digesto de Normas Técnico Registrales, el texto completo de sus
          principales Disposiciones complementarias y Circulares aclaratorias,
          con un breve resumen del contenido de las mismas, y diversos artículos
      ...
      <div class="container">
        ...
        <article class="faq-item">
          ...
          <p>
            ...
            pantalla completa desde un lanzador, como cualquier otra aplicación.
          </p>
          <p>
            Abra FucerNet desde su tablet o celular ingresando a
            net.fucer.com.ar. Luego, localice en su navegador el ícono de
            "compartir”. Haga click en el mismo y seleccione la opción "Agregar
            a Inicio”.
          </p>
          <p>
            Un ícono de FucerNet va a apararecer en el inicio de su dispositivo
            y podrá abrirla desde ahí.
          </p>
        </article>
        <article class="faq-item">
          <h4>¿Cómo puedo abonar FucerNet?</h4>
          <p>
            FucerNet cuenta con dos medios de pago. Uno de ellos es una tarjeta
            de crédito, a la cual la aplicación le cobrará de manera mensual y
            automática el monto de la suscripción (de la misma forma que
            servicios como Netflix o Spotify).
          </p>
        ...
        <article class="faq-item">
          ...
          <p>
            Todos los pagos son procesados y administrados por Mercado Pago, una
            de las plataformas de pagos más seguras y populares del país. La
            información de la tarjeta de crédito que usted agrega en FucerNet es
            100% procesada por Mercado Pago, desde Fucer no intervenimos en el
            proceso. Es decir, no tenemos acceso a la información de su tarjeta
            de crédito. Adicionalmente, Mercado Pago tiene como requisito que
            las aplicaciones que utilicen sus servicios cuenten con un
            certificado de conexión segura SSL. Cuando ingrese a FucerNet desde
            un navegador, a la izquierda de la URL (net.fucer.com.ar) va a
            visualizar un candado que indica que la conexión al sitio es segura.
          </p>
        </article>
      </div>
    </section>
        ...
        <div class="footer-info">
          ...
          <div class="footer-info_menu">
            <ul>
              ...
              <li>
                <nuxt-link :to="{ name: 'seleccione-su-plan' }">
                  Probar 15 días
                </nuxt-link>
              </li>
            </ul>
            <ul>
              <li>
                <a href="mailto:soporte@fucer.com.ar" target="_blank"
